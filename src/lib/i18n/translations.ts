...
const translations = {
	en: {
		...
		chords: {
			...
			Sus2: { name: 'Sus2', hint: '3rd replaced by 2nd' },
			Sus4: { name: 'Sus4', hint: '3rd replaced by 4th' },
	...
	cs: {
		...
		chords: {
			...
			Sus2: { name: 'Sus2', hint: 'Tercie nahrazena sekundou' },
			Sus4: { name: 'Sus4', hint: 'Tercie nahrazena kvartou' },
			'5': { name: 'Powerakord', hint: 'Jen zaklad a kvinta, bez tercie' },
			...
			mMaj7: { name: 'Mollově-durový 7', hint: 'Mollový kvintakord + velká septima' },
			'7sus4': { name: '7sus4', hint: 'Dominantní 7 se kvartou místo tercie' },
			'6': { name: 'Durový 6', hint: 'Durový kvintakord + velká sexta' },
			m6: { name: 'Mollový 6', hint: 'Mollový kvintakord + velká sexta' },
			add9: { name: 'Add 9', hint: 'Durový kvintakord + nóna (bez septimy)' },
